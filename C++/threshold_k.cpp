...
void run(uint32_t mem, uint32_t detectT, uint32_t detectK, uint8_t total_periods, string name) {
    ...
    if (strcmp(name.c_str(), "PSSBM") == 0) {
        ...
        string outputFilePath = "../KExp/PSS_BM_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
    ...
    if (strcmp(name.c_str(), "PSSHLL") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../KExp/PSS_HLL_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
        saveResults(outputFilePath, skt, realFlowInfo, detectT, detectK, name, throughput);
    }
    ...
    if (strcmp(name.c_str(), "KTSketch") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../KExp/KTSketch_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
    ...
    if (strcmp(name.c_str(), "HLLsampler") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../KExp/HLLsampler_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
        saveResults(outputFilePath, skt, realFlowInfo, detectT, detectK, name, throughput);
    }
    ...
    if (strcmp(name.c_str(), "SpreadSketch") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../KExp/SpreadSketch_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
        saveResults(outputFilePath, skt, realFlowInfo, detectT, detectK, name, throughput);
    }
    ...
    if (strcmp(name.c_str(), "FreeRS") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../KExp/FreeRS_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
        saveResults(outputFilePath, skt, realFlowInfo, detectT, detectK, name, throughput);
    }
}
