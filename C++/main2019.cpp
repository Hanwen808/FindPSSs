...
//    if (strcmp(name.c_str(), "PSSBM") == 0 || strcmp(name.c_str(), "PSSHLL") == 0) {
    clock_t start = clock();
    skt->post_process();
...
void run(uint32_t mem, uint32_t detectT, uint32_t detectK, uint8_t total_periods, string name) {
    ...
    string dataDir = R"(../../../../ZSL/dataset/CAIDA2019_600wPerTXT/)";
    ...
    if (strcmp(name.c_str(), "PSSBM") == 0) {
        ...
        string outputFilePath = "../records_CAIDA19/PSS_BM_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
    ...
    if (strcmp(name.c_str(), "PSSHLL") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../records_CAIDA19/PSS_HLL_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
        saveResults(outputFilePath, skt, realFlowInfo, detectT, detectK, name, throughput);
    }
    ...
    if (strcmp(name.c_str(), "KTSketch") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../records_CAIDA19/KTSketch_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
    ...
    if (strcmp(name.c_str(), "HLLsampler") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../records_CAIDA19/HLLsampler_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
        saveResults(outputFilePath, skt, realFlowInfo, detectT, detectK, name, throughput);
    }
    ...
    if (strcmp(name.c_str(), "SpreadSketch") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../records_CAIDA19/SpreadSketch_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
        saveResults(outputFilePath, skt, realFlowInfo, detectT, detectK, name, throughput);
    }
    ...
    if (strcmp(name.c_str(), "FreeRS") == 0) {
        ...
        cout << endl;
        cout << "save the result in txt ..." << endl;
        string outputFilePath = "../records_CAIDA19/FreeRS_" + std::to_string(mem) + "_" + std::to_string(detectT) + "_" + std::to_string(detectK) + ".txt";
        saveResults(outputFilePath, skt, realFlowInfo, detectT, detectK, name, throughput);
    }
}
